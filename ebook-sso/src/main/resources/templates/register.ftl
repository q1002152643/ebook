...
<body>
	<div class="w" id="logo">
		<div>
			<a href="${DomainBaseUrl}"> <img
				src="/images/logo.jpg" width="170" height="60" />
			</a> <b></b>
		</div>
	</div>
				...
				<div class="form" onselectstart="return false;">
					...
					<div id="o-password">
						...
						<div class="item" style="height:70px;">
							...
							<div class="fl item-ifo">
								<input type="text" id="verifycode" maxlength="11" class="text" tabindex="4"
									autocomplete="off" />
								<div>
									<img src="/page/verifycode" id="myimg" title="换一换"
										onclick="change();" style="cursor: pointer;" />
									<script type="text/javascript">
										function change() {
											// 切换验证码
											document.getElementById("myimg").src = "/page/verifycode?"
													+ new Date().getTime();
										}
									</script>
...
<br />
						...
						<div class="fl item-ifo">
							<input type="checkbox" class="checkbox" checked="checked"
								...
								for="protocol">我已阅读并同意<a href="#" class="blue"
									id="protocol">《书城用户注册协议》</a></label> <span class="clr"></span> <label
		...
		<script type="text/javascript">
			var REGISTER = {
				...
				inputcheck : function() {
					var verifycode = $.cookie("verifycode");
					//alert(verifycode);
					if ($("#verifycode").val() =="") {
						alert("请输入验证码");
						$("#verifycode").focus();
